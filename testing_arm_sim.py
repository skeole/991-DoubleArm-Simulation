...
while run:
    ...
    TE.type("target position is (" + str(round(point[0], 1)) + ", " + str(round(point[1], 1)) + ")", font, (int(display_size[0] * 0.5), int(display_size[1] * 0.1)), display_size[1] / 1600, display_size[1] / 1600, black, 2, space_between_letters=display_size[1] / 133.33)
    TE.type("target angles are (" + str(round(tangles[0], 1)) + ", " + str(round(tangles[1], 1)) + ")", font, (int(display_size[0] * 0.5), int(display_size[1] * 0.175)), display_size[1] / 1600, display_size[1] / 1600, black, 2, space_between_letters=display_size[1] / 133.33)
