...
while run:
    ...
    drawPolygons(
        ...
        (smartDashboard.getNumber("Current Angle 1", -80), smartDashboard.getNumber("Current Angle 2", 80)), 
        (smartDashboard.getNumber("Target 1st Angle", -60), smartDashboard.getNumber("Target 2nd Angle", 60))
    )
